# date: 9/13/24
# author: Yuezhe Li 
# purpose of this code: to remove T cells in spleen & BM; remove B cells in spleen; replace B cell output into bone marrow as a constant
# this version was adopted from tdb_cyno_6.jl

using DifferentialEquations, ModelingToolkit 

include("param.jl");

function TDB_homo8(; name)
    ...
    B_leaving_BM = 2.055E9 # based on steady state
    # diff equations
    eqs = [
        # T cells
